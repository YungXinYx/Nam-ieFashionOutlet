...
public class StaffViewDeliveryStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            session.setAttribute("success", "none");
            session.setAttribute("deliveryList", deliveryList);
            response.sendRedirect("secureStaff/UpdateDeliveryStatus.jsp");
        } catch (Exception ex) {
            Logger.getLogger(StaffViewDeliveryStatus.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
